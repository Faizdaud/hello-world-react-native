...
import { StyleSheet, Text, View, Image, Button, Alert,  TouchableOpacity, TouchableHighlight } from 'react-native';

export default function App() {

  //Create a variable which is a called a counter
  // To change the value of the variable, I will use setCounter method...
  // counter = counter + 1 -> we will not use this
  ...
  return (
    <View style={styles.container}>
      ...
      <Text>{counter}</Text>
      <TouchableOpacity style={styles.Increment} onPress= {() => setCounter(counter + 1)}>
        <Text>Increment</Text>
      </TouchableOpacity>

      <TouchableHighlight style={styles.Decrement} onPress= {() => setCounter(counter - 1)}>
        <Text>Decrement</Text>
      </TouchableHighlight>
